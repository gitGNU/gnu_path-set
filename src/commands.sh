...
path-set-test()
{
    ...
    local stal='dups-line uniq-line line-mem dups-elem uniq-elem dups-node uniq-node elem-insert-eq elem-insert-lt elem-insert-gt elem-insert-ne elem-insert-hit elem-rehash-eq elem-rehash-ne elem-rehash-hit node-insert-eq node-insert-lt node-insert-gt node-insert-ne node-insert-hit node-rehash-eq node-rehash-ne node-rehash-hit hash-size hash-used hash-load elem-struct-size node-struct-size elem-struct node-struct elem-mem node-mem total-node-mem total-mem real-insert-time user-insert-time sys-insert-time real-lookup-time user-lookup-time sys-lookup-time'
    local stax="@(${stal// /|})"
