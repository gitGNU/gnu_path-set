...
path-set-test()
{
    ...
    local stal='dups-line uniq-line line-mem dups-elem uniq-elem dups-node uniq-node elem-insert-eq elem-insert-lt elem-insert-gt elem-insert-ne elem-insert-hit elem-rehash-eq elem-rehash-ne elem-rehash-op elem-rehash-hit real-elem-rehash-time user-elem-rehash-time sys-elem-rehash-time elem-realloc-op real-elem-realloc-time user-elem-realloc-time sys-elem-realloc-time node-insert-eq node-insert-lt node-insert-gt node-insert-ne node-insert-hit node-rehash-eq node-rehash-ne node-rehash-op node-rehash-hit real-node-rehash-time user-node-rehash-time sys-node-rehash-time node-realloc-op real-node-realloc-time user-node-realloc-time sys-node-realloc-time hash-size hash-used hash-load elem-struct-size node-struct-size elem-struct node-struct elem-mem node-mem total-node-mem total-mem real-insert-time user-insert-time sys-insert-time real-lookup-time user-lookup-time sys-lookup-time'
    local stax="@(${stal// /|})"
