...
static size_t lhash_plain_set_get_param_total_mem(
    const struct lhash_plain_set_t* set)
{
    size_t n, s;

    n = lhash_plain_set_get_param_total_node_mem(set);
    s = plain_lhash_get_struct_mem(&set->impl);
    ...
    const struct lhash_plain_set_t* set, bool only_names, FILE* file)
{
    static const struct stat_param_info_t params[] = {
        ...
        FSIZE(rehash_hit,       impl.stats.rehash_hit),
        ...
        SFUNC(total_mem,        lhash_plain_set_get_param_total_mem),
